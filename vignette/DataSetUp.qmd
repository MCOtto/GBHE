...
readr::write_csv(GRTSLoc, here::here("data/tblObservations.csv"), na = "")
...
In 2015, change the UTMs to lat-longs.
Add the locations for 2015 using the colony list.
...
```
These are all the tables we need for the estimation.
