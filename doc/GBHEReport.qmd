...
author: "Mark C. Otto. 25 September 2024"
echo: false
eval: true
warning: false
error: false
...
We did use a different colony list for 2023 but should use the 2015 list with the new
colonies found.

```{r New2015Colonies}
New2015 <- RecObs %>%
  filter(Year == 2015 & stringr::str_detect(FWSColonyID, "new")) %>%
  mutate(nNest = pmax(fNest, rNest, na.rm = TRUE),
